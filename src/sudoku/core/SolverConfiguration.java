...
/**
 * This class contains methods for storing and retrieving configured components
 * of the application.
 */
public class SolverConfiguration {
	...
	private int practicingPuzzlesLevel;

	private final SolutionTechniqueConfiguration[] orgSolverSteps;

	private final SolutionTechniqueConfiguration[] solverSteps;

	private final SolutionTechniqueConfiguration[] solverStepsProgress;

	public static SolverConfiguration getInstance() {
		if (instance == null) {
	...
	public int getPractisingPuzzlesLevel() {
		return this.practicingPuzzlesLevel;
	}

	public int getPracticingPuzzlesLevel() {
		return this.practicingPuzzlesLevel;
	}

	public void setPracticingPuzzlesLevel(int practicingPuzzlesLevel) {
		this.practicingPuzzlesLevel = practicingPuzzlesLevel;
	}
	...
	public SolutionTechniqueConfiguration[] getSolverSteps() {
		return this.solverSteps;
	}

	public SolutionTechniqueConfiguration[] getSolverStepsProgress() {
		return this.solverStepsProgress;
	}
